...
<div class="c-split-content bg-contain bg-repeat-y bg-left relative <?php echo esc_attr($className); ?> bg-beige" id="split-content" style="background-image: url(/wp-content/themes/becks/assets/dist/images/trax.png)">
