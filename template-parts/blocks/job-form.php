    ...
    <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
      <div class="space-y-6 sm:space-y-5">
        <div class="c-form-header">
          <h3 class="text-lg font-medium leading-6 text-black"><?php echo get_field('header'); ?></h3>
          <p class="mt-1 max-w-2xl text-sm text-black">This information will be displayed publicly so be careful what you share.</p>
        </div>
        ...
        <div class="space-y-6 sm:space-y-5">
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
            ...
            <div class="mt-1 sm:col-span-2 sm:mt-0">
              <div class="flex max-w-lg rounded-md shadow-sm">
                <span class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-50 px-3 text-black sm:text-sm">workcation.com/</span>
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
            ...
            <div class="mt-1 sm:col-span-2 sm:mt-0">
              ...
              <p class="mt-2 text-sm text-black">Write a few sentences about yourself.</p>
            </div>
          </div>
      ...
      <div class="space-y-6 pt-8 sm:space-y-5 sm:pt-10">
        <div>
          ...
          <p class="mt-1 max-w-2xl text-sm text-black">Use a permanent address where you can receive mail.</p>
        </div>
        <div class="space-y-6 sm:space-y-5">
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
      ...
      <div class="space-y-6 divide-y divide-gray-200 pt-8 sm:space-y-5 sm:pt-10">
        <div>
          <h3 class="text-lg font-medium leading-6 text-black">Notifications</h3>
          <p class="mt-1 max-w-2xl text-sm text-black">We'll always let you know about important changes, but you pick what else you want to hear about.</p>
        </div>
        <div class="space-y-6 divide-y divide-gray-200 sm:space-y-5">
          <div class="pt-6 sm:pt-5">
            <div role="group" aria-labelledby="label-email">
              <div class="sm:grid sm:grid-cols-3 sm:items-baseline sm:gap-4">
                <div>
                  <div class="text-base font-medium text-black sm:text-sm sm:text-gray-700" id="label-email">By Email</div>
                </div>
                  ...
                  <div class="max-w-lg space-y-4">
                    <div class="relative flex items-start">
                      ...
                      <div class="ml-3 text-sm">
                        ...
                        <p class="text-black">Get notified when someones posts a comment on a posting.</p>
                      </div>
                    </div>
                    <div class="relative flex items-start">
                      <div class="flex h-5 items-center">
                      ...
                      <div class="ml-3 text-sm">
                        ...
                        <p class="text-black">Get notified when a candidate applies for a job.</p>
                      </div>
                    </div>
                    <div class="relative flex items-start">
                      <div class="flex h-5 items-center">
                      ...
                      <div class="ml-3 text-sm">
                        ...
                        <p class="text-black">Get notified when a candidate accepts or rejects an offer.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="pt-6 sm:pt-5">
            <div role="group" aria-labelledby="label-notifications">
              <div class="sm:grid sm:grid-cols-3 sm:items-baseline sm:gap-4">
                <div>
                  <div class="text-base font-medium text-black sm:text-sm sm:text-gray-700" id="label-notifications">Push Notifications</div>
                </div>
                <div class="sm:col-span-2">
                  <div class="max-w-lg">
                    <p class="text-sm text-black">These are delivered via SMS to your mobile phone.</p>
